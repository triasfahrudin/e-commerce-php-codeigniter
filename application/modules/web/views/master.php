...
<html dir="ltr" lang="en">
   <head>
      ...
      <script type="text/JavaScript" src="<?php echo site_url('assets/web/js/cuties.js');?>"></script>
      <!--[if lt IE 9]>
            ...
            <div id="header_right">
               ...
               <div id="cart">
                  <div class="heading">
                     <div class="cart_top_in">
                        <h4>Keranjang</h4>
                        <a><span id="cart-total">2 item(s) - Rp369.000</span></a>
                     </div>
                  </div>
                  <div class="content">
                     <div class="mini-cart-info">
                        <table>
                           <tbody>
                              <tr>
                                 <td class="image"><a href="product.html"><img src="<?php echo site_url('assets/web/image/ex/pro-1.png');?>" alt="" title=""></a></td>
                                 <td class="name">
                                    <a href="product.html">Scitote</a>
                                    <div> </div>
                                 </td>
                                 <td class="quantity">x&nbsp;1</td>
                                 <td class="total">$236.99</td>
                                 <td class="remove"><img src="<?php echo site_url('assets/web/image/remove-small.png');?>" alt="Remove" title="Remove"></td>
                              </tr>
                              <tr>
                                 <td class="image"><a href="product.html"><img src="<?php echo site_url('assets/web/image/ex/pro-2.png');?>" alt="" title=""></a></td>
                                 <td class="name">
                                    <a href="product.html">Retrorsum</a>
                                    <div> </div>
                                 </td>
                                 <td class="quantity">x&nbsp;1</td>
               ...
               <div id="bottom_right">                  
                  ...
                  <div class="links">
                     ...
                     <?php if(isset($logged_in)){ ?>   
                     <a href="<?php echo site_url('akunku')?>">Akun ku</a>
                     <?php } ?>
