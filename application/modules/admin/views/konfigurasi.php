   ...
   <table width="100%" class="table table-condensed">
      <thead>
         <tr>
            ...
            <th style="text-align: left">Konfigurasi</th>
      ...
      <tbody>
         ...
         <tr>
              ...
              <script>
                CKEDITOR.on('instanceCreated', function (e) {
                  e.editor.on('change', function (event) {
                    ...
                    $.post( "<?php echo base_url() . 'admin/web_konfigurasi/edt/';?>" + this_title,
                      { value: this_val }
                    );
                  });
                });
            ...
            <?php }elseif($r->tipe === 'image'){ ?>
              ...
              <form action="<?php echo base_url() . 'admin/web_konfigurasi/upload/' . $r->title;?>" method="POST" enctype="multipart/form-data">
                ...
                function initialize_<?php echo $r->title?>() {
                    ...
                    google.maps.event.addListener(map_<?php echo $r->title?>, 'click', function(event) {
                      ...
                      //$('#lng').val(event.latLng.lng());
                        $.post( "<?php echo base_url() . 'admin/web_konfigurasi/edt/' . $r->title;?>" ,
